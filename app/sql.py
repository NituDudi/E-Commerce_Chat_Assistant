...
def sql_chain(question):
    ...
    if response is None:
        return "Sorry, there was a problem in executing SQL query"

    context=response.to_dict(orient="records")
    result=data_comprehnsion(question,context)
    return result
...
if __name__=="__main__":
    ...
    question="All NIKE shoes in price range 5000 t0 1000"
